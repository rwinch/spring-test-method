...
import org.springframework.test.context.support.DefaultMethodTestContextBootstrapper;

@Documented
@Inherited
@Retention(RetentionPolicy.RUNTIME)
@Target({ElementType.METHOD, ElementType.TYPE})
@BootstrapWith(DefaultMethodTestContextBootstrapper.class)
@ContextConfiguration
public @interface MethodContextConfiguration {
